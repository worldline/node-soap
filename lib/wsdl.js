 ...
 */
WSDL.prototype.getAttributesNamesInOrder = function(obj, parameterTypeObject) {
  var keys = Object.keys(obj);
  // Check if it's a sequence
  if(parameterTypeObject && parameterTypeObject.name === 'complexType') {
    var sequence = _.find(parameterTypeObject.children, { name: 'sequence' });
...
WSDL.prototype.objectToXML = function(obj, name, namespace, xmlns, first, xmlnsAttr, parameterTypeObject, ancestorXmlns) {
  ...
  if (Array.isArray(obj)) {
    ...
    var attributeNames = self.getAttributesNamesInOrder(obj, parameterTypeObject);
      ...
      if (first) {
        ...
        if (self.definitions.schemas) {
          if (schema) {
            ...
            } else if (childParameterTypeObject) {
