...
WSDL.prototype.getAttributesNamesInOrder = function(obj, parameterTypeObject, first) {
  ...
  // console.dir(tmpParameterTypeObject);
...
WSDL.prototype.objectToXML = function(obj, name, namespace, xmlns, first, xmlnsAttr, parameterTypeObject, ancestorXmlns) {
  ...
  if (Array.isArray(obj)) {
    ...
    for (var j = 0; j < attributeNames.length; ++j) {
      ...
      var nonSubNameSpace = '';
      if (first) {
        var childNamespace = (parameterTypeObject && parameterTypeObject.childNameSpace) ? parameterTypeObject.childNameSpace : namespace;
        value = self.objectToXML(child, name, childNamespace, xmlns, false, null, parameterTypeObject, ancXmlns);
      } else {
