...
Client.prototype._defineMethod = function(method, location) {
  ...
  return function(args, callback, options, extraHeaders) {
    ...
    self._invoke(method, args, location, function(error, result, raw, soapHeader,attachments, parts) {
      callback(error, result, raw, soapHeader,attachments, parts);
...
Client.prototype._invoke = function(method, args, location, callback, options, extraHeaders) {
  ...
  req = self.httpClient.request(location, xml, function(err, response, body,attachments, parts) {
    var result;
    var obj;
    ...
    if (err) {
      ...
      callback(null, result, body, obj.Header,attachments, parts);
    }
