...
var Client = require('./client').Client,
  ...
  open_wsdlSync = require('./wsdl').open_wsdlSync,
...
function _requestWSDLSync(path, options){
  var wsdl = open_wsdlSync(path, options);
  _wsdlCache[path] = wsdl;
  return wsdl;
}
...
function createClientSync(path, options, endpoint){
  endpoint = options.endpoint || endpoint;
  var wsdl = _requestWSDLSync(path, options);
  return new Client(wsdl, endpoint, options);
}
...
exports.createClientSync = createClientSync;
